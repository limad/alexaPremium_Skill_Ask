...
class Jeedom(Borg):
    ...
    def _post(self, *path: str, body: dict, extra_headers: Optional[dict] = None):
        ...
        #logger.debug(f"Raw response POST: {response.data}")
    ...
    def get_ha_state(self):
        ...
        """
        logger.debug("ici!!!")
        logger.debug("INPUT_TEXT_ENTITY: " + INPUT_TEXT_ENTITY)
    ...
    def post_ha_event(self, response: str, response_type: str, **kwargs) -> Optional[str]:
        ...
        """
        body = {"event_id": self.ha_state.event_id, "event_response": response, "event_response_type": response_type, "deviceSerialNumber": self.ha_state.deviceSerialNumber}
        body.update(kwargs)
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        """Handler for Skill Launch."""
        ha_obj = Jeedom(handler_input)
        speak_output: Optional[str] = ha_obj.ha_state.text
        event_id: Optional[str] = ha_obj.ha_state.event_id
        deviceSerialNumber: Optional[str] = ha_obj.ha_state.deviceSerialNumber
